...
namespace Revolutions.Module.Components.Revolts.Models
{
    public class SettlementLoyaltyModel : DefaultSettlementLoyaltyModel
    {
        public override float CalculateLoyaltyChange(Town town, StatExplainer statExplainer = null)
        {
            ...
            var explainedNumber = new ExplainedNumber(0, statExplainer);
            ...
            NotablesChange(settlementInfo, ref explainedNumber);
            ImperialChange(settlementInfo, ref explainedNumber);
            OverextensionChange(settlementInfo, ref explainedNumber);
            LuckyNationChange(settlementInfo, ref explainedNumber);
