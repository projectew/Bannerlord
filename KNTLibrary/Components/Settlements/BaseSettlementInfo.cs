...
namespace KNTLibrary.Components.Settlements
{
    ...
    public class BaseSettlementInfo : IBaseComponent<BaseSettlementInfo>
    {
        ...
        public BaseFactionInfo InitialFactionInfo => BaseManagers.Faction.GetInfo(this.InitialFactionId);

        public IFaction CurrentFaction => BaseManagers.Faction.GetGameObject(this.CurrentFactionId);

        public BaseFactionInfo CurrentFactionInfo => BaseManagers.Faction.GetInfo(this.CurrentFactionId);

        public IFaction PreviousFaction => BaseManagers.Faction.GetGameObject(this.PreviousFactionId);

        public BaseFactionInfo PreviousFactionInfo => BaseManagers.Faction.GetInfo(this.PreviousFactionId);
